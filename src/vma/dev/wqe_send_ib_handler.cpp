...
void wqe_send_ib_handler::init_path_record(struct ibv_send_wr &wqe_to_init, struct ibv_ah *ah, uint32_t rem_qkey, uint32_t rem_qpn)
{
...
void wqe_send_ib_handler::init_wqe(struct ibv_send_wr &wqe_to_init, struct ibv_sge* sge_list, uint32_t num_sge,
...
void wqe_send_ib_handler::init_inline_wqe(struct ibv_send_wr &wqe_to_init, struct ibv_sge* sge_list, uint32_t num_sge,
		    struct ibv_ah *ah, uint32_t rem_qpn, uint32_t rem_qkey)
{
...
//code coverage
#if 0
void wqe_send_ib_handler::enable_imm_data(struct ibv_send_wr &send_wqe)
{
	send_wqe.opcode = IBV_WR_SEND_WITH_IMM;
	send_wqe.imm_data = MCE_IMM_DATA_MASK_MC_TX_LOOP_DISABLED;
}

void wqe_send_ib_handler::disable_imm_data(struct ibv_send_wr &send_wqe)
{
