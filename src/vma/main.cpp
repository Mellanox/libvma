...
void print_vma_global_settings()
{
	...
	VLOG_PARAM_NUMSTR("Exception handling mode", mce_sys.vma_exception_handling, MCE_DEFAULT_VMA_EXCEPTION_HANDLING, SYS_VAR_VMA_EXCEPTION_HANDLING, vma_exception_handling_str(mce_sys.vma_exception_handling));
...
void get_env_params()
{
	...
	mce_sys.vma_exception_handling	= MCE_DEFAULT_VMA_EXCEPTION_HANDLING;
...
//		mce_sys.cq_allocation_logic	= CQ_ALLOC_LOGIC__CQ_PER_QP;
	...
	if ((env_ptr = getenv(SYS_VAR_VMA_EXCEPTION_HANDLING)) != NULL) {
			mce_sys.vma_exception_handling = (vma_exception_handling_t)atoi(env_ptr);
			if (mce_sys.vma_exception_handling >= VMA_EXCEPTION_LAST || mce_sys.vma_exception_handling < -1)
				mce_sys.vma_exception_handling = MCE_DEFAULT_VMA_EXCEPTION_HANDLING;
	}
