...
#define SYS_VAR_TCP_MAX_ACCEPT_RATE			"VMA_TCP_MAX_ACCEPT_RATE"
...
#define MCE_DEFAULT_TCP_MAX_ACCEPT_RATE                 (0)
...
#define TCP_MAX_ACCEPT_RATE_TOP_LIMIT			100000
