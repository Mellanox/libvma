...
#define SYS_VAR_NUM_BUFS_QUANTA_TOKEN_NAME              "quanta_n_bufs"
...
#define MCE_DEFAULT_TX_NUM_BUFS_QUANTA			MCE_DEFAULT_TX_NUM_BUFS_INIT
...
#define MCE_DEFAULT_RX_NUM_BUFS_QUANTA			MCE_DEFAULT_RX_NUM_BUFS_INIT
